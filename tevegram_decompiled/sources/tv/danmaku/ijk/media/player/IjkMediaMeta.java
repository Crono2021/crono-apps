...
public class IjkMediaMeta {
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        if (parcelableArrayList != null) {
            ...
            int i12 = 0;
            while (i12 < size) {
                Bundle bundle2 = parcelableArrayList.get(i12);
                i12++;
                Bundle bundle3 = bundle2;
                i9++;
                if (bundle3 != null) {
                    IjkStreamMeta ijkStreamMeta = new IjkStreamMeta(i9);
                    ijkStreamMeta.mMeta = bundle3;
    ...
    public String getDurationInline() {
        long j5 = (this.mDurationUS + k.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS) / 1000000;
        long j9 = j5 / 60;
        return String.format(Locale.US, "%02d:%02d:%02d", Long.valueOf(j9 / 60), Long.valueOf(j9 % 60), Long.valueOf(j5 % 60));
    }
    ...
    public static class IjkStreamMeta {
        ...
        public String getResolutionInline() {
            int i9 = this.mWidth;
            if (i9 <= 0 || this.mHeight <= 0) {
                return "N/A";
            }
            if (this.mSarNum <= 0 || this.mSarDen <= 0) {
                Locale locale = Locale.US;
                return i9 + " x " + this.mHeight;
            }
            Locale locale2 = Locale.US;
            return i9 + " x " + this.mHeight + " [SAR " + this.mSarNum + ":" + this.mSarDen + "]";
        }
