...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public static class MediaDataSourceProxy extends MediaDataSource {
        ...
        @Override // android.media.MediaDataSource
        public int readAt(long j5, byte[] bArr, int i9, int i10) {
            return this.mMediaDataSource.readAt(j5, bArr, i9, i10);
        }
    }
    ...
    public void deselectTrack(int i9) {
        this.mInternalMediaPlayer.deselectTrack(i9);
    }
    ...
    public int getSelectedTrack(int i9) {
        return this.mInternalMediaPlayer.getSelectedTrack(i9);
    }
    ...
    public float getSpeed() {
        ...
        playbackParams = this.mInternalMediaPlayer.getPlaybackParams();
    ...
    public void seekTo(long j5) {
        this.mInternalMediaPlayer.seekTo((int) j5);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void selectTrack(int i9) {
        this.mInternalMediaPlayer.selectTrack(i9);
    }
    ...
    public void setLooping(boolean z8) {
        this.mInternalMediaPlayer.setLooping(z8);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setScreenOnWhilePlaying(boolean z8) {
        this.mInternalMediaPlayer.setScreenOnWhilePlaying(z8);
    }
    ...
    public void setSpeed(float f9) {
        ...
        PlaybackParams i9 = f.i();
        i9.setPitch(f9);
        i9.setSpeed(f9);
        this.mInternalMediaPlayer.setPlaybackParams(i9);
    }
