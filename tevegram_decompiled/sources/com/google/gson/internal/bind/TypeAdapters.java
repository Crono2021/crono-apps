...
public final class TypeAdapters {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public T read(JsonReader jsonReader) {
            ...
            T t8 = this.nameToConstant.get(nextString);
            return t8 == null ? this.stringToConstant.get(nextString) : t8;
        }
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i10 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    boolean z8 = true;
                    if (i10 == 1 || i10 == 2) {
                        ...
                        if (nextInt == 0) {
                            ...
                            StringBuilder p5 = g.p(nextInt, "Invalid bitset value ", ", expected 0 or 1; at path ");
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder p5 = g.p(nextInt, "Lossy conversion from ", " to byte; at path ");
                    p5.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(p5.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    StringBuilder p5 = g.p(nextInt, "Lossy conversion from ", " to short; at path ");
                    p5.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(p5.toString());
                } catch (NumberFormatException e9) {
                    throw new JsonSyntaxException(e9);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read(JsonReader jsonReader) {
                ...
                StringBuilder r8 = g.r("Expecting character, got: ", nextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    a.k(g.r("Failed parsing '", nextString, "' as BigDecimal; at path "), jsonReader.getPreviousPath(), e9);
                    return null;
                }
            }
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    a.k(g.r("Failed parsing '", nextString, "' as BigInteger; at path "), jsonReader.getPreviousPath(), e9);
                    return null;
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    a.k(g.r("Failed parsing '", nextString, "' as UUID; at path "), jsonReader.getPreviousPath(), e9);
                    return null;
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read(JsonReader jsonReader) {
                ...
                try {
                    ...
                    a.k(g.r("Failed parsing '", nextString, "' as Currency; at path "), jsonReader.getPreviousPath(), e9);
                    return null;
                }
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) {
                int i9 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i9 == 1) {
                ...
                a.r(jsonToken, "Unexpected token: ");
                return null;
            }
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) {
                ...
                if (!jsonElement.isJsonObject()) {
                    a.g(jsonElement.getClass(), "Couldn't write ");
                    return;
                }
                jsonWriter.beginObject();
