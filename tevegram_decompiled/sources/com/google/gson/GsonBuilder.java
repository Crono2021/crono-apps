...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i9, int i10, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            ...
            TypeAdapterFactory createAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i9, i10);
            if (z8) {
                typeAdapterFactory3 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i9, i10);
                TypeAdapterFactory createAdapterFactory2 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i9, i10);
