...
public final class w extends b {
    public static w b(j jVar, i7.x xVar, Integer num) {
        ...
        if (aVar.f8980a.length != 32) {
            throw new GeneralSecurityException("XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not " + aVar.f8980a.length);
        }
        if (jVar == jVar2) {
            t6.a.a(new byte[0]);
        } else if (jVar == j.f3770p) {
