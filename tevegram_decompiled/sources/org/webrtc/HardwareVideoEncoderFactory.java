...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z8, boolean z9, Predicate<MediaCodecInfo> predicate) {
        ...
        this.enableIntelVp8Encoder = z8;
        this.enableH264HighProfile = z9;
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z8, boolean z9) {
        this(context, z8, z9, null);
    }

    @Deprecated
    public HardwareVideoEncoderFactory(boolean z8, boolean z9) {
        this(null, z8, z9);
    }
}
