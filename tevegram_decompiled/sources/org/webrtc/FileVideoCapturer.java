...
public class FileVideoCapturer implements VideoCapturer {
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) {
            ...
            while (true) {
                ...
                if (read == -1) {
                    m7.c.i(t.a.b("Found end of file before end of header for file: ", str));
                    throw null;
                }
                if (read == 10) {
                    ...
                    if (!str2.equals("420") && !str2.equals("420mpeg2")) {
                        m7.c.n("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i9 % 2 == 1 || i10 % 2 == 1) {
                        m7.c.n("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i9;
    ...
    public void startCapture(int i9, int i10, int i11) {
        this.timer.schedule(this.tickTask, 0L, IjkMediaCodecInfo.RANK_MAX / i11);
    }
