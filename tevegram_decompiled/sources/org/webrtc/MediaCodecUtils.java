...
class MediaCodecUtils {
    ...
    public static Map<String, String> getCodecProperties(VideoCodecMimeType videoCodecMimeType, boolean z8) {
        int i9 = AnonymousClass1.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i9 == 1 || i9 == 2 || i9 == 3 || i9 == 4) {
            return new HashMap();
        }
        if (i9 == 5) {
            return H264Utils.getDefaultH264Params(z8);
        }
        androidx.fragment.app.a.n(videoCodecMimeType, "Unsupported codec: ");
        return null;
    }
