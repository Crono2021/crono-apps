...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    public static class NetworkState {
        ...
        public NetworkState(boolean z8, int i9, int i10, int i11, int i12) {
            this.connected = z8;
            this.type = i9;
            this.subtype = i10;
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        SimpleNetworkCallback simpleNetworkCallback = new SimpleNetworkCallback(this, 0);
    ...
    private static NetworkChangeDetector.ConnectionType getConnectionType(boolean z8, int i9, int i10) {
        if (!z8) {
    ...
    public class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public /* synthetic */ SimpleNetworkCallback(NetworkMonitorAutoDetect networkMonitorAutoDetect, int i9) {
            this();
        }
    }
    ...
    public static class WifiManagerDelegate {
        ...
        public String getWifiSSID() {
            ...
            int i9 = Build.VERSION.SDK_INT;
            Context context = this.context;
            Intent registerReceiver = i9 >= 33 ? context.registerReceiver(null, new IntentFilter("android.net.wifi.STATE_CHANGE"), 4) : context.registerReceiver(null, new IntentFilter("android.net.wifi.STATE_CHANGE"));
        ...
        public long getDefaultNetId() {
            ...
            for (Network network : getAllNetworks()) {
                if (hasInternetCapability(network) && (networkInfo = this.connectivityManager.getNetworkInfo(network)) != null && networkInfo.getType() == activeNetworkInfo.getType()) {
                    if (j5 != NetworkMonitorAutoDetect.INVALID_NET_ID) {
                        m7.c.i("Multiple connected networks of same type are not supported.");
                        return 0L;
                    }
                    j5 = NetworkMonitorAutoDetect.networkToNetId(network);
                }
            }
            return j5;
        }
