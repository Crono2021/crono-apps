...
public class RtpTransceiver {
    ...
    public enum RtpTransceiverDirection {
        ...
        public static RtpTransceiverDirection fromNativeIndex(int i9) {
            ...
            m7.c.n(androidx.activity.g.m(i9, "Uknown native RtpTransceiverDirection type"));
            return null;
        }
    ...
    @CalledByNative
    public RtpTransceiver(long j5) {
        this.nativeRtpTransceiver = j5;
        this.cachedSender = nativeGetSender(j5);
        this.cachedReceiver = nativeGetReceiver(j5);
    }
    ...
    private void checkRtpTransceiverExists() {
        ...
        m7.c.p("RtpTransceiver has been disposed.");
    }

    private static native RtpTransceiverDirection nativeCurrentDirection(long j5);

    private static native RtpTransceiverDirection nativeDirection(long j5);

    private static native MediaStreamTrack.MediaType nativeGetMediaType(long j5);

    private static native String nativeGetMid(long j5);

    private static native RtpReceiver nativeGetReceiver(long j5);

    private static native RtpSender nativeGetSender(long j5);

    private static native void nativeSetCodecPreferences(long j5, List<RtpCapabilities.CodecCapability> list);

    private static native boolean nativeSetDirection(long j5, RtpTransceiverDirection rtpTransceiverDirection);

    private static native void nativeStopInternal(long j5);

    private static native void nativeStopStandard(long j5);

    private static native boolean nativeStopped(long j5);
