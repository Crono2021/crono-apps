...
public class PeerConnection {
    ...
    public enum AdapterType {
        ...
        CELLULAR_3G(128),
        CELLULAR_4G(256),
        CELLULAR_5G(Integer.valueOf(IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED));
    ...
    private native boolean nativeAddLocalStream(long j5);

    private native RtpSender nativeAddTrack(long j5, List<String> list);

    private native RtpTransceiver nativeAddTransceiverOfType(MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit);

    private native RtpTransceiver nativeAddTransceiverWithTrack(long j5, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit);
    ...
    private static native void nativeFreeOwnedPeerConnection(long j5);
    ...
    private native void nativeNewGetStatsReceiver(long j5, RTCStatsCollectorCallback rTCStatsCollectorCallback);

    private native void nativeNewGetStatsSender(long j5, RTCStatsCollectorCallback rTCStatsCollectorCallback);

    private native boolean nativeOldGetStats(StatsObserver statsObserver, long j5);

    private native boolean nativeRemoveIceCandidates(IceCandidate[] iceCandidateArr);

    private native void nativeRemoveLocalStream(long j5);

    private native boolean nativeRemoveTrack(long j5);

    private native void nativeRestartIce();

    private native void nativeSetAudioPlayout(boolean z8);

    private native void nativeSetAudioRecording(boolean z8);
    ...
    public RtpSender addTrack(MediaStreamTrack mediaStreamTrack, List<String> list) {
        if (mediaStreamTrack == null || list == null) {
            m7.c.o("No MediaStreamTrack specified in addTrack.");
            return null;
        }
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack mediaStreamTrack, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
        if (mediaStreamTrack == null) {
            m7.c.o("No MediaStreamTrack specified for addTransceiver.");
            return null;
        }
        ...
        m7.c.p("C++ addTransceiver failed.");
        return null;
    }
    ...
    public boolean removeTrack(RtpSender rtpSender) {
        ...
        m7.c.o("No RtpSender specified for removeTrack.");
        return false;
    }
    ...
    public void setAudioPlayout(boolean z8) {
        nativeSetAudioPlayout(z8);
    }

    public void setAudioRecording(boolean z8) {
        nativeSetAudioRecording(z8);
    }
    ...
    public static class IceServer {
        ...
        private IceServer(String str, List<String> list, String str2, String str3, TlsCertPolicy tlsCertPolicy, String str4, List<String> list2, List<String> list3) {
            if (str == null || list == null || list.isEmpty()) {
                m7.c.n("uri == null || urls == null || urls.isEmpty()");
                throw null;
            }
            Iterator<String> it = list.iterator();
            while (it.hasNext()) {
                if (it.next() == null) {
                    androidx.fragment.app.a.n(list, "urls element is null: ");
                    throw null;
                }
            }
            if (str2 == null) {
                m7.c.n("username == null");
                throw null;
            }
            if (str3 == null) {
                m7.c.n("password == null");
                throw null;
            }
            if (str4 == null) {
                m7.c.n("hostname == null");
                throw null;
            }
            this.uri = str;
            this.urls = list;
        ...
        public static class Builder {
            ...
            private Builder(List<String> list) {
                ...
                if (list == null || list.isEmpty()) {
                    androidx.fragment.app.a.n(list, "urls == null || urls.isEmpty(): ");
                    throw null;
                }
                this.urls = list;
            }
            ...
            public /* synthetic */ Builder(int i9, List list) {
                this(list);
            }
        }
        ...
        public /* synthetic */ IceServer(String str, List list, String str2, String str3, TlsCertPolicy tlsCertPolicy, String str4, List list2, List list3, int i9) {
    ...
    public RtpTransceiver addTransceiver(MediaStreamTrack.MediaType mediaType, RtpTransceiver.RtpTransceiverInit rtpTransceiverInit) {
        ...
        m7.c.o("No MediaType specified for addTransceiver.");
        return null;
    }
}
