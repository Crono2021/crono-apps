...
.method public final hasElements$kotlinx_coroutines_core()Z
    ...
    .line 2261
    invoke-direct {p0, v12, v13, v1}, Lkotlinx/coroutines/channels/BufferedChannel;->findSegmentReceive(JLkotlinx/coroutines/channels/ChannelSegment;)Lkotlinx/coroutines/channels/ChannelSegment;
    ...
    .line 2272
    .local v0, "i":I
    invoke-direct {p0, v1, v0, v8, v9}, Lkotlinx/coroutines/channels/BufferedChannel;->isCellNonEmpty(Lkotlinx/coroutines/channels/ChannelSegment;IJ)Z
...
.method public final toStringDebug$kotlinx_coroutines_core()Ljava/lang/String;
    ...
    const-string v2, "SEND_SEGM="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-object v2, Lkotlinx/coroutines/channels/BufferedChannel;->sendSegment$FU:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    .local v1, "$this$minBy$iv":Ljava/lang/Iterable;
    .restart local v2    # "$i$f$minByOrThrow":I
...
.method public final waitExpandBufferCompletion$kotlinx_coroutines_core(J)V
    ...
    .local v1, "$this$ebCompletedCounter$iv":J
    const/4 v3, 0x0

    .line 3894
    .local v3, "$i$f$getEbCompletedCounter":I
    and-long/2addr v1, v8

    .line 1425
    .end local v1    # "$this$ebCompletedCounter$iv":J
    .end local v3    # "$i$f$getEbCompletedCounter":I
    move-wide v4, v1
    ...
    .local v1, "$this$ebPauseExpandBuffers$iv":J
    const/4 v3, 0x0

    .line 3895
    .local v3, "$i$f$getEbPauseExpandBuffers":I
    ...
    .line 1426
    .end local v1    # "$this$ebPauseExpandBuffers$iv":J
    .end local v3    # "$i$f$getEbPauseExpandBuffers":I
    :goto_3
    move v14, v1
