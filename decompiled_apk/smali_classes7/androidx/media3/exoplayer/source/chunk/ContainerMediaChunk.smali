...
.method public constructor <init>(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Landroidx/media3/common/Format;ILjava/lang/Object;JJJJJIJLandroidx/media3/exoplayer/source/chunk/ChunkExtractor;)V
    ...
    iput-wide v2, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->sampleOffsetUs:J

    .line 92
    move-object/from16 v4, p19

    iput-object v4, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->chunkExtractor:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor;
...
.method private maybeWriteEmptySamples(Landroidx/media3/exoplayer/source/chunk/BaseMediaChunkOutput;)V
    ...
    iget-object v1, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->trackFormat:Landroidx/media3/common/Format;
    ...
    invoke-virtual {v3, v2, v1}, Landroidx/media3/exoplayer/source/chunk/BaseMediaChunkOutput;->track(II)Landroidx/media3/extractor/TrackOutput;

    move-result-object v1

    .line 165
    .local v1, "trackOutput":Landroidx/media3/extractor/TrackOutput;
    iget-object v4, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->trackFormat:Landroidx/media3/common/Format;

    iget v4, v4, Landroidx/media3/common/Format;->tileCountHorizontal:I

    iget-object v5, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->trackFormat:Landroidx/media3/common/Format;
    ...
    .line 166
    .local v11, "tileCount":I
    iget-wide v4, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->endTimeUs:J

    iget-wide v6, v0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->startTimeUs:J
    ...
    invoke-interface {v1, v4, v2}, Landroidx/media3/extractor/TrackOutput;->sampleData(Landroidx/media3/common/util/ParsableByteArray;I)V
    ...
    .line 168
    .end local v15    # "tileStartTimeUs":J
    ...
    .end local v11    # "tileCount":I
    .end local v12    # "tileDurationUs":J
    :cond_5
    move-object/from16 v3, p1
...
.method public final load()V
    ...
    .line 116
    .local v0, "output":Landroidx/media3/exoplayer/source/chunk/BaseMediaChunkOutput;
    ...
    :goto_2
    :try_start_1
    iget-boolean v3, p0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->loadCanceled:Z

    if-nez v3, :cond_3

    iget-object v3, p0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->chunkExtractor:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor;

    invoke-interface {v3, v2}, Landroidx/media3/exoplayer/source/chunk/ChunkExtractor;->read(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    iget-object v5, p0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->dataSpec:Landroidx/media3/datasource/DataSpec;

    iget-wide v5, v5, Landroidx/media3/datasource/DataSpec;->position:J

    sub-long/2addr v3, v5

    iput-wide v3, p0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->nextLoadPosition:J
    :try_end_2
    ...
    iput-boolean v1, p0, Landroidx/media3/exoplayer/source/chunk/ContainerMediaChunk;->loadCompleted:Z
    ...
    .end local v0    # "output":Landroidx/media3/exoplayer/source/chunk/BaseMediaChunkOutput;
    throw v3
    :try_end_3
    ...
    .end local v1    # "loadDataSpec":Landroidx/media3/datasource/DataSpec;
    .end local v2    # "input":Landroidx/media3/extractor/ExtractorInput;
    .restart local v0    # "output":Landroidx/media3/exoplayer/source/chunk/BaseMediaChunkOutput;
    :catchall_1
    move-exception v1
