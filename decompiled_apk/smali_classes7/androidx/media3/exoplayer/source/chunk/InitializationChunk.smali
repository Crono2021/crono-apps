...
.method public load()V
    ...
    .line 104
    .local v1, "input":Landroidx/media3/extractor/ExtractorInput;
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Landroidx/media3/exoplayer/source/chunk/InitializationChunk;->loadCanceled:Z

    if-nez v2, :cond_1

    iget-object v2, p0, Landroidx/media3/exoplayer/source/chunk/InitializationChunk;->chunkExtractor:Landroidx/media3/exoplayer/source/chunk/ChunkExtractor;

    invoke-interface {v2, v1}, Landroidx/media3/exoplayer/source/chunk/ChunkExtractor;->read(Landroidx/media3/extractor/ExtractorInput;)Z
    ...
    iget-object v4, p0, Landroidx/media3/exoplayer/source/chunk/InitializationChunk;->dataSpec:Landroidx/media3/datasource/DataSpec;

    iget-wide v4, v4, Landroidx/media3/datasource/DataSpec;->position:J

    sub-long/2addr v2, v4

    iput-wide v2, p0, Landroidx/media3/exoplayer/source/chunk/InitializationChunk;->nextLoadPosition:J
    :try_end_2
    ...
    .end local v1    # "input":Landroidx/media3/extractor/ExtractorInput;
    ...
    .line 106
    .restart local v0    # "loadDataSpec":Landroidx/media3/datasource/DataSpec;
    .restart local v1    # "input":Landroidx/media3/extractor/ExtractorInput;
    :catchall_0
    move-exception v2
