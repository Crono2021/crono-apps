...
.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;ILandroidx/media3/common/util/Clock;Z)V
    ...
    invoke-virtual {v0, v1}, Landroidx/media3/common/util/NetworkTypeObserver;->register(Landroidx/media3/common/util/NetworkTypeObserver$Listener;)V
    ...
    .line 338
    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->getInitialBitrateEstimateForNetworkType(I)J
...
.method private declared-synchronized onNetworkTypeChanged(I)V
    ...
    .line 435
    iget v1, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->networkTypeOverride:I
    :try_end_1
    ...
    iput-wide v2, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J
    ...
    .line 460
    iget-object v2, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->slidingPercentile:Landroidx/media3/exoplayer/upstream/SlidingPercentile;
...
.method public declared-synchronized onTransferEnd(Landroidx/media3/datasource/DataSource;Landroidx/media3/datasource/DataSpec;Z)V
    ...
    iget-object v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->slidingPercentile:Landroidx/media3/exoplayer/upstream/SlidingPercentile;
    ...
    invoke-virtual {v5, v6, v4}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;->addSample(IF)V

    .line 417
    iget-wide v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalElapsedTimeMs:J
    ...
    iget-wide v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->totalBytesTransferred:J
    ...
    invoke-virtual {v5, v6}, Landroidx/media3/exoplayer/upstream/SlidingPercentile;->getPercentile(F)F

    move-result v5

    float-to-long v5, v5

    iput-wide v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->bitrateEstimate:J
    ...
    .line 422
    iput-wide v2, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleStartTimeMs:J

    .line 423
    const-wide/16 v5, 0x0

    iput-wide v5, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->sampleBytesTransferred:J

    .line 425
    .end local v4    # "bitsPerSecond":F
    :cond_4
    iget v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I

    sub-int/2addr v4, v1

    iput v4, p0, Landroidx/media3/exoplayer/upstream/DefaultBandwidthMeter;->streamCount:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
