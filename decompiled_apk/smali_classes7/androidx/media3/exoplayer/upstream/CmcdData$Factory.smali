...
.method public constructor <init>(Landroidx/media3/exoplayer/upstream/CmcdConfiguration;Landroidx/media3/exoplayer/trackselection/ExoTrackSelection;JFLjava/lang/String;ZZZ)V
    ...
    .param p5, "playbackRate"    # F
    .param p6, "streamingFormat"    # Ljava/lang/String;
    .param p7, "isLive"    # Z
    .param p8, "didRebuffer"    # Z
    .param p9, "isBufferEmpty"    # Z
...
.method public createCmcdData()Landroidx/media3/exoplayer/upstream/CmcdData;
    ...
    .line 232
    .local v0, "customData":Lcom/google/common/collect/ImmutableListMultimap;, "Lcom/google/common/collect/ImmutableListMultimap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .line 239
    .local v3, "cmcdObject":Landroidx/media3/exoplayer/upstream/CmcdData$CmcdObject$Builder;
    ...
    .end local v6    # "i":I
    :cond_2
    invoke-static {v5, v2}, Landroidx/media3/common/util/Util;->ceilDivide(II)I
    ...
    .line 252
    iget-wide v4, p0, Landroidx/media3/exoplayer/upstream/CmcdData$Factory;->chunkDurationUs:J

    invoke-static {v4, v5}, Landroidx/media3/common/util/Util;->usToMs(J)J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdObject$Builder;->setObjectDurationMs(J)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdObject$Builder;
    ...
    .line 264
    iget-wide v4, p0, Landroidx/media3/exoplayer/upstream/CmcdData$Factory;->bufferedDurationUs:J

    invoke-static {v4, v5}, Landroidx/media3/common/util/Util;->usToMs(J)J

    move-result-wide v4

    invoke-virtual {v2, v4, v5}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;->setBufferLengthMs(J)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;
    ...
    invoke-static {v4, v5, v6, v7}, Landroidx/media3/common/util/Util;->ceilDivide(JJ)J

    move-result-wide v4

    .line 268
    invoke-virtual {v2, v4, v5}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;->setMeasuredThroughputInKbps(J)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;
    ...
    invoke-virtual {v2, v4, v5}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;->setDeadlineMs(J)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;
    ...
    :goto_3
    invoke-virtual {v2, v4}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;->setStartup(Z)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdRequest$Builder;
    ...
    .line 288
    .local v4, "cmcdSession":Landroidx/media3/exoplayer/upstream/CmcdData$CmcdSession$Builder;
    ...
    .line 308
    .local v5, "cmcdStatus":Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;
    ...
    .line 309
    invoke-virtual {v5, v6}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;->setMaximumRequestedThroughputKbps(I)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;

    .line 312
    :cond_17
    iget-object v6, p0, Landroidx/media3/exoplayer/upstream/CmcdData$Factory;->cmcdConfiguration:Landroidx/media3/exoplayer/upstream/CmcdConfiguration;

    invoke-virtual {v6}, Landroidx/media3/exoplayer/upstream/CmcdConfiguration;->isBufferStarvationLoggingAllowed()Z
    ...
    invoke-virtual {v5, v6}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;->setBufferStarvation(Z)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;

    .line 315
    :cond_18
    const-string v6, "CMCD-Status"

    invoke-virtual {v0, v6}, Lcom/google/common/collect/ImmutableListMultimap;->containsKey(Ljava/lang/Object;)Z
    ...
    .line 316
    invoke-virtual {v0, v6}, Lcom/google/common/collect/ImmutableListMultimap;->get(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList;

    move-result-object v6

    invoke-virtual {v5, v6}, Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;->setCustomDataList(Ljava/util/List;)Landroidx/media3/exoplayer/upstream/CmcdData$CmcdStatus$Builder;
    ...
    iget v12, v7, Landroidx/media3/exoplayer/upstream/CmcdConfiguration;->dataTransmissionMode:I
