...
.method public varargs constructor <init>(Landroid/view/Display;[Landroidx/media3/exoplayer/video/spherical/OrientationListener$Listener;)V
    ...
    .param p2, "listeners"    # [Landroidx/media3/exoplayer/video/spherical/OrientationListener$Listener;
...
.method private extractRoll([F)F
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->angles:[F
...
.method private notifyListeners([FF)V
    ...
    .line 75
    .local v3, "listener":Landroidx/media3/exoplayer/video/spherical/OrientationListener$Listener;
    ...
    .line 74
    .end local v3    # "listener":Landroidx/media3/exoplayer/video/spherical/OrientationListener$Listener;
...
.method private rotateAroundZ([FI)V
    ...
    .line 118
    :goto_0
    iget-object v2, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->tempMatrix4x4:[F
...
.method public onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->display:Landroid/view/Display;

    invoke-virtual {v1}, Landroid/view/Display;->getRotation()I

    move-result v1

    invoke-direct {p0, v0, v1}, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->rotateAroundZ([FI)V

    .line 61
    iget-object v0, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->deviceOrientationMatrix4x4:[F

    invoke-direct {p0, v0}, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->extractRoll([F)F

    move-result v0

    .line 63
    .local v0, "roll":F
    iget-object v1, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->deviceOrientationMatrix4x4:[F

    invoke-static {v1}, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->rotateYtoSky([F)V

    .line 64
    iget-object v1, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->deviceOrientationMatrix4x4:[F

    invoke-direct {p0, v1}, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->recenter([F)V

    .line 65
    iget-object v1, p0, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->deviceOrientationMatrix4x4:[F

    invoke-direct {p0, v1, v0}, Landroidx/media3/exoplayer/video/spherical/OrientationListener;->notifyListeners([FF)V
