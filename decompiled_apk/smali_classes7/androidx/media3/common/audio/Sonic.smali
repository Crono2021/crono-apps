...
.method public constructor <init>(IIFFI)V
    ...
    iput-object v1, p0, Landroidx/media3/common/audio/Sonic;->downSampleBuffer:[S
    ...
    iput-object v0, p0, Landroidx/media3/common/audio/Sonic;->pitchBuffer:[S
...
.method private adjustRate(FI)V
    ...
    iget v1, p0, Landroidx/media3/common/audio/Sonic;->inputSampleRateHz:I
    ...
    .line 383
    :goto_2
    iget v3, p0, Landroidx/media3/common/audio/Sonic;->oldRatePosition:I

    add-int/lit8 v4, v3, 0x1

    mul-int/2addr v4, v0

    iget v6, p0, Landroidx/media3/common/audio/Sonic;->newRatePosition:I
    ...
    .line 385
    invoke-direct {p0, v3, v4, v5}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S

    move-result-object v3

    iput-object v3, p0, Landroidx/media3/common/audio/Sonic;->outputBuffer:[S
    ...
    .line 388
    iget-object v6, p0, Landroidx/media3/common/audio/Sonic;->outputBuffer:[S
    ...
    iget-object v8, p0, Landroidx/media3/common/audio/Sonic;->pitchBuffer:[S
    ...
    .line 389
    invoke-direct {p0, v8, v4, v1, v0}, Landroidx/media3/common/audio/Sonic;->interpolate([SIII)S
    ...
    .end local v3    # "i":I
    :cond_2
    iget v3, p0, Landroidx/media3/common/audio/Sonic;->newRatePosition:I

    add-int/2addr v3, v5

    iput v3, p0, Landroidx/media3/common/audio/Sonic;->newRatePosition:I
    ...
    iput v3, p0, Landroidx/media3/common/audio/Sonic;->outputFrameCount:I
    ...
    iput v3, p0, Landroidx/media3/common/audio/Sonic;->oldRatePosition:I
    ...
    invoke-direct {p0, v3}, Landroidx/media3/common/audio/Sonic;->removePitchFrames(I)V
...
.method private downSampleInput([SII)V
    ...
    .line 236
    iget-object v4, p0, Landroidx/media3/common/audio/Sonic;->downSampleBuffer:[S
...
.method private findPitchPeriod([SI)I
    ...
    invoke-direct {p0, p1, p2, v1, v2}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    .line 315
    invoke-direct {p0, p1, p2, v3, v4}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    .line 318
    iget-object v1, p0, Landroidx/media3/common/audio/Sonic;->downSampleBuffer:[S

    invoke-direct {p0, v1, v5, v3, v4}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    .restart local v1    # "period":I
    :goto_1
    iget v2, p0, Landroidx/media3/common/audio/Sonic;->minDiff:I

    iget v3, p0, Landroidx/media3/common/audio/Sonic;->maxDiff:I

    invoke-direct {p0, v2, v3}, Landroidx/media3/common/audio/Sonic;->previousPeriodBetter(II)Z
    ...
    :goto_2
    iget v3, p0, Landroidx/media3/common/audio/Sonic;->minDiff:I

    iput v3, p0, Landroidx/media3/common/audio/Sonic;->prevMinDiff:I
...
.method private findPitchPeriodInRange([SIII)I
    ...
    iput v4, p0, Landroidx/media3/common/audio/Sonic;->minDiff:I
...
.method private previousPeriodBetter(II)Z
    ...
    iget v2, p0, Landroidx/media3/common/audio/Sonic;->prevMinDiff:I
...
.method private processStreamInput()V
    ...
    invoke-direct {p0, v2, v5, v4}, Landroidx/media3/common/audio/Sonic;->copyToOutput([SII)V
...
.method public queueEndOfStream()V
    ...
    iget v5, p0, Landroidx/media3/common/audio/Sonic;->inputFrameCount:I

    iget v6, p0, Landroidx/media3/common/audio/Sonic;->maxRequiredFrameCount:I
    ...
    .line 140
    invoke-direct {p0, v4, v5, v6}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S

    move-result-object v4

    iput-object v4, p0, Landroidx/media3/common/audio/Sonic;->inputBuffer:[S
    ...
    .local v4, "xSample":I
    :goto_0
    iget v5, p0, Landroidx/media3/common/audio/Sonic;->maxRequiredFrameCount:I
    ...
    .line 143
    iget-object v5, p0, Landroidx/media3/common/audio/Sonic;->inputBuffer:[S
