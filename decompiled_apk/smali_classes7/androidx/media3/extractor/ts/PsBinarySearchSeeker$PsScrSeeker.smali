...
.method private constructor <init>(Landroidx/media3/common/util/TimestampAdjuster;)V
    ...
    iput-object v0, p0, Landroidx/media3/extractor/ts/PsBinarySearchSeeker$PsScrSeeker;->packetBuffer:Landroidx/media3/common/util/ParsableByteArray;
...
.method synthetic constructor <init>(Landroidx/media3/common/util/TimestampAdjuster;Landroidx/media3/extractor/ts/PsBinarySearchSeeker$1;)V
    .locals 0
    .param p1, "x0"    # Landroidx/media3/common/util/TimestampAdjuster;
    .param p2, "x1"    # Landroidx/media3/extractor/ts/PsBinarySearchSeeker$1;
...
.method private searchForScrValueInBuffer(Landroidx/media3/common/util/ParsableByteArray;JJ)Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;
    ...
    invoke-static {v7, v11}, Landroidx/media3/extractor/ts/PsBinarySearchSeeker;->access$100([BI)I
    ...
    .line 106
    invoke-static/range {p1 .. p1}, Landroidx/media3/extractor/ts/PsDurationReader;->readScrValueFromPack(Landroidx/media3/common/util/ParsableByteArray;)J
    ...
    iget-object v13, v8, Landroidx/media3/extractor/ts/PsBinarySearchSeeker$PsScrSeeker;->scrTimestampAdjuster:Landroidx/media3/common/util/TimestampAdjuster;

    invoke-virtual {v13, v11, v12}, Landroidx/media3/common/util/TimestampAdjuster;->adjustTsTimestamp(J)J
    ...
    .line 112
    invoke-static {v13, v14, v1, v2}, Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;->overestimatedResult(JJ)Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;
    ...
    invoke-static {v9, v10}, Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;->targetFoundResult(J)Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;
    ...
    .line 126
    :goto_1
    invoke-static/range {p1 .. p1}, Landroidx/media3/extractor/ts/PsBinarySearchSeeker$PsScrSeeker;->skipToEndOfCurrentPack(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-static {v5, v6, v9, v10}, Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;->underestimatedResult(JJ)Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;
...
.method private static skipToEndOfCurrentPack(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-static {v2, v4}, Landroidx/media3/extractor/ts/PsBinarySearchSeeker;->access$100([BI)I
    ...
    invoke-static {v4, v5}, Landroidx/media3/extractor/ts/PsBinarySearchSeeker;->access$100([BI)I
...
.method public searchForTimestamp(Landroidx/media3/extractor/ExtractorInput;J)Landroidx/media3/extractor/BinarySearchSeeker$TimestampSearchResult;
    ...
    invoke-virtual {v0, v8}, Landroidx/media3/common/util/ParsableByteArray;->reset(I)V
    ...
    invoke-interface {p1, v0, v1, v8}, Landroidx/media3/extractor/ExtractorInput;->peekFully([BII)V
