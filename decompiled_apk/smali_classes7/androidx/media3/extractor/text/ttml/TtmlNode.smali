...
.method private applyStyleToOutput(Ljava/util/Map;Landroidx/media3/common/text/Cue$Builder;III)V
    ...
    .line 402
    .local v0, "resolvedStyle":Landroidx/media3/extractor/text/ttml/TtmlStyle;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->tag:Ljava/lang/String;
    ...
    invoke-virtual {p2, v2}, Landroidx/media3/common/text/Cue$Builder;->setShearDegrees(F)Landroidx/media3/common/text/Cue$Builder;
    ...
    invoke-virtual {p2, v2}, Landroidx/media3/common/text/Cue$Builder;->setTextAlignment(Landroid/text/Layout$Alignment;)Landroidx/media3/common/text/Cue$Builder;
    ...
    invoke-virtual {p2, v2}, Landroidx/media3/common/text/Cue$Builder;->setMultiRowAlignment(Landroid/text/Layout$Alignment;)Landroidx/media3/common/text/Cue$Builder;
...
.method private traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    iget-object v0, v6, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;
    ...
    check-cast v12, Landroidx/media3/common/text/Cue$Builder;

    .line 385
    .local v12, "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    ...
    .line 382
    .end local v12    # "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    ...
    .line 390
    invoke-virtual {v6, v0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->getChild(I)Landroidx/media3/extractor/text/ttml/TtmlNode;
...
.method private traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    .line 331
    invoke-static {v0, p5}, Landroidx/media3/extractor/text/ttml/TtmlNode;->getRegionOutputText(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;

    move-result-object v1

    iget-object v2, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->text:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeStartsByRegion:Ljava/util/HashMap;
    ...
    invoke-static {v1}, Landroidx/media3/extractor/text/ttml/TtmlRenderUtil;->endParagraph(Landroid/text/SpannableStringBuilder;)V
    ...
    .line 351
    .restart local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    iget-object v3, p0, Landroidx/media3/extractor/text/ttml/TtmlNode;->nodeEndsByRegion:Ljava/util/HashMap;
...
.method public getCues(JLjava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    iget-object v0, v13, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;

    move-wide/from16 v11, p1

    invoke-direct {v13, v11, v12, v0, v15}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForImage(JLjava/lang/String;Ljava/util/List;)V
    ...
    .line 257
    .local v5, "regionTextOutputs":Ljava/util/TreeMap;, "Ljava/util/TreeMap<Ljava/lang/String;Landroidx/media3/common/text/Cue$Builder;>;"
    const/4 v3, 0x0

    iget-object v4, v13, Landroidx/media3/extractor/text/ttml/TtmlNode;->regionId:Ljava/lang/String;
    ...
    invoke-direct/range {v6 .. v12}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    check-cast v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;
    ...
    .line 274
    .local v9, "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    new-instance v10, Landroidx/media3/common/text/Cue$Builder;

    invoke-direct {v10}, Landroidx/media3/common/text/Cue$Builder;-><init>()V

    .line 276
    invoke-virtual {v10, v8}, Landroidx/media3/common/text/Cue$Builder;->setBitmap(Landroid/graphics/Bitmap;)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v10

    iget v11, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->position:F

    .line 277
    invoke-virtual {v10, v11}, Landroidx/media3/common/text/Cue$Builder;->setPosition(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v10

    .line 278
    invoke-virtual {v10, v6}, Landroidx/media3/common/text/Cue$Builder;->setPositionAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v10

    iget v11, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->line:F

    .line 279
    invoke-virtual {v10, v11, v6}, Landroidx/media3/common/text/Cue$Builder;->setLine(FI)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v6

    iget v10, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineAnchor:I

    .line 280
    invoke-virtual {v6, v10}, Landroidx/media3/common/text/Cue$Builder;->setLineAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v6

    iget v10, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->width:F

    .line 281
    invoke-virtual {v6, v10}, Landroidx/media3/common/text/Cue$Builder;->setSize(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v6

    iget v10, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->height:F

    .line 282
    invoke-virtual {v6, v10}, Landroidx/media3/common/text/Cue$Builder;->setBitmapHeight(F)Landroidx/media3/common/text/Cue$Builder;

    move-result-object v6

    iget v10, v9, Landroidx/media3/extractor/text/ttml/TtmlRegion;->verticalType:I

    .line 283
    invoke-virtual {v6, v10}, Landroidx/media3/common/text/Cue$Builder;->setVerticalType(I)Landroidx/media3/common/text/Cue$Builder;
    ...
    .end local v9    # "region":Landroidx/media3/extractor/text/ttml/TtmlRegion;
    goto :goto_0
    ...
    check-cast v6, Landroidx/media3/common/text/Cue$Builder;

    .line 291
    .local v6, "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    invoke-virtual {v6}, Landroidx/media3/common/text/Cue$Builder;->getText()Ljava/lang/CharSequence;
    ...
    invoke-static {v7}, Landroidx/media3/extractor/text/ttml/TtmlNode;->cleanUpText(Landroid/text/SpannableStringBuilder;)V

    .line 292
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->line:F

    iget v8, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineType:I

    invoke-virtual {v6, v7, v8}, Landroidx/media3/common/text/Cue$Builder;->setLine(FI)Landroidx/media3/common/text/Cue$Builder;

    .line 293
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->lineAnchor:I

    invoke-virtual {v6, v7}, Landroidx/media3/common/text/Cue$Builder;->setLineAnchor(I)Landroidx/media3/common/text/Cue$Builder;

    .line 294
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->position:F

    invoke-virtual {v6, v7}, Landroidx/media3/common/text/Cue$Builder;->setPosition(F)Landroidx/media3/common/text/Cue$Builder;

    .line 295
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->width:F

    invoke-virtual {v6, v7}, Landroidx/media3/common/text/Cue$Builder;->setSize(F)Landroidx/media3/common/text/Cue$Builder;

    .line 296
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->textSize:F

    iget v8, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->textSizeType:I

    invoke-virtual {v6, v7, v8}, Landroidx/media3/common/text/Cue$Builder;->setTextSize(FI)Landroidx/media3/common/text/Cue$Builder;

    .line 297
    iget v7, v3, Landroidx/media3/extractor/text/ttml/TtmlRegion;->verticalType:I

    invoke-virtual {v6, v7}, Landroidx/media3/common/text/Cue$Builder;->setVerticalType(I)Landroidx/media3/common/text/Cue$Builder;
    ...
    .end local v6    # "regionOutput":Landroidx/media3/common/text/Cue$Builder;
    goto :goto_1
