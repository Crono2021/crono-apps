...
.method public constructor <init>(Landroidx/media3/extractor/ExtractorOutput;Landroidx/media3/extractor/TrackOutput;Landroidx/media3/extractor/wav/WavFormat;)V
    ...
    iget-object v3, p3, Landroidx/media3/extractor/wav/WavFormat;->extraData:[B

    invoke-direct {v2, v3}, Landroidx/media3/common/util/ParsableByteArray;-><init>([B)V

    .line 445
    .local v2, "scratch":Landroidx/media3/common/util/ParsableByteArray;
    ...
    iput v3, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->framesPerBlock:I

    .line 448
    iget v4, p3, Landroidx/media3/extractor/wav/WavFormat;->numChannels:I
    ...
    iget v6, p3, Landroidx/media3/extractor/wav/WavFormat;->bitsPerSample:I
    ...
    .line 465
    invoke-static {v0, v3}, Landroidx/media3/common/util/Util;->ceilDivide(II)I

    move-result v1

    .line 466
    .local v1, "maxBlocksToDecode":I
    iget v6, p3, Landroidx/media3/extractor/wav/WavFormat;->blockSize:I

    mul-int/2addr v6, v1

    new-array v6, v6, [B

    iput-object v6, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->inputData:[B

    .line 467
    new-instance v6, Landroidx/media3/common/util/ParsableByteArray;

    .line 469
    invoke-static {v3, v4}, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->numOutputFramesToBytes(II)I
    ...
    iput-object v6, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->decodedData:Landroidx/media3/common/util/ParsableByteArray;

    .line 473
    iget v6, p3, Landroidx/media3/extractor/wav/WavFormat;->frameRateHz:I

    iget v7, p3, Landroidx/media3/extractor/wav/WavFormat;->blockSize:I
    ...
    invoke-virtual {v3, v7}, Landroidx/media3/common/Format$Builder;->setSampleMimeType(Ljava/lang/String;)Landroidx/media3/common/Format$Builder;
    ...
    .line 478
    invoke-virtual {v3, v6}, Landroidx/media3/common/Format$Builder;->setPeakBitrate(I)Landroidx/media3/common/Format$Builder;

    move-result-object v3

    .line 479
    invoke-static {v0, v4}, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->numOutputFramesToBytes(II)I

    move-result v0

    invoke-virtual {v3, v0}, Landroidx/media3/common/Format$Builder;->setMaxInputSize(I)Landroidx/media3/common/Format$Builder;
    ...
    invoke-virtual {v0, v3}, Landroidx/media3/common/Format$Builder;->setPcmEncoding(I)Landroidx/media3/common/Format$Builder;
    ...
    iput-object v0, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->format:Landroidx/media3/common/Format;
...
.method private decodeBlockForChannel([BII[B)V
    ...
    invoke-static {v8, v2, v1}, Landroidx/media3/common/util/Util;->constrainValue(III)I
...
.method private writeSampleMetadata(I)V
    ...
    .line 558
    .local v2, "size":I
    iget v3, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingOutputBytes:I
    ...
    .line 561
    iget-wide v4, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->outputFrameCount:J

    int-to-long v6, p1

    add-long/2addr v4, v6

    iput-wide v4, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->outputFrameCount:J

    .line 562
    iget v4, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingOutputBytes:I

    sub-int/2addr v4, v2

    iput v4, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->pendingOutputBytes:I
...
.method public init(IJ)V
    ...
    .line 498
    iget-object v0, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->trackOutput:Landroidx/media3/extractor/TrackOutput;

    iget-object v1, p0, Landroidx/media3/extractor/wav/WavExtractor$ImaAdPcmOutputWriter;->format:Landroidx/media3/common/Format;
